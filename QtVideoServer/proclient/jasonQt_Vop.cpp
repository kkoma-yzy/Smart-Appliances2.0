...
bool BaiduVop::refreshToken(void)
{
    ...
    QByteArray append = QString("grant_type=client_credentials&client_id=%1&client_secret=%2&").arg("7YSNAv24emdNrXGlBsZT6O8z").arg("iZiuuv78lFt7MI6nOOHZsxSBww9Kfb9K").toLatin1();
    QByteArray buf;
